    ...
    -->
      ...
      <div class="contaier">
        ...
        <div class="cont">
          ...
          {
            echo '
            <center> <h5 style="color: red;" > Your Test Is Submited , Please Wait Team Coach To Approve Your Requset </h5> </center>
            <br>
            <br>
            <br>
              ';
          ...
          if(isset($_SESSION['regst']) && $_SESSION['regst'] == 3 && $row['Code'] == $_SESSION['teamcode']) 
           {
            echo '
            <center> <h5 style="color: red;" > congratulation Your Request Is Approved , Team Coach Will Contact You SOON </h5> </center>
            <br>
            <br>
            <br>
            <a href="jointeam.php?do=outteam&Code='.$Code.'"> <button class="btn-join">Exit team</button></a>
