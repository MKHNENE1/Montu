      ...
      <table class="table" id="myTable">
        ...
        <tbody>
              ...
              foreach($rows as $rowss) {
                  ...
                  echo '<a class="accept" id="update" href="jointouradmin.php?do=jointour&Code='.$rowss['TOURNAMENT_CODE'].'&TeamLeaderName='.$rowss['TEAM_LEADER'].'">accept</a> ' ;
                  echo '<a class="remove" id="delete" href="jointouradmin.php?do=exittour&Code='.$rowss['TOURNAMENT_CODE'].'&TeamLeaderName='.$rowss['TEAM_LEADER'].'">remove</a> ' ;
                  echo '</td>' ;
                  echo '</tr>' ;
              }
                ?>
